...
public class MyPageController {
    ...
    // 평가된 한줄평 가져오기
    @GetMapping("/revwrt")
    public String readRevwRtList(HttpSession session, Model m) throws Exception {
    ...
    //보유 아이템 목록
    @GetMapping("/myItem")
    public String readMyItemList( HttpSession session, Model m) throws Exception {
    ...
    @GetMapping("/point")
    public String pointList( HttpSession session, Model m) {
