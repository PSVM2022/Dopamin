                ...
                <nav class="card">
                    <ul class="menu-category">
                        <li class="has-submenu"><a href="#">아이템 목록</a>
                            <ul class="submenu">
                                <li><a href="#">프로필 스킨</a></li>
                                <li><a href="#">프로필 꾸미기</a></li>
    ...
    <div id="multi1" class="container">
        ...
        <div id="multi" class="row">
            <c:forEach var="i" begin="0" end="7">
                <div id="item_card" class="col-md-3">
                    <div id="item_img" class="card card-product-grid" >
                        ...
                        <figcaption class="info-wrap">
                            ...
                            <a href="#" class="title">${list[i].item_nm}</a>
                            <div class="price mt-1">${list[i].item_price} DP</div> <!-- price-wrap.// -->
                        </figcaption>
                    </div>
                </div> <!-- col.// -->
            </c:forEach>
